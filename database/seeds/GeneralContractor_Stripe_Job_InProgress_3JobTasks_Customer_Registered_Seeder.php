...
class GeneralContractor_Stripe_Job_InProgress_3JobTasks_Customer_Registered_Seeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        DB::table('job_status')->insert([
            ['id' => 1, 'job_id' => 1, 'status' => 'initiated', 'status_number' => 1],
            ['id' => 2, 'job_id' => 1, 'status' => 'in_progress', 'status_number' => 2, 'sent_on' => '2121-01-23']
        ]);
