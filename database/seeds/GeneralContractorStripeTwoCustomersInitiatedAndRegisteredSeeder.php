...
class GeneralContractorStripeTwoCustomersInitiatedAndRegisteredSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        DB::table('users')->insert([
            ...
            'phone' => '6024326933',
            'customer_stripe_id' => NULL,
            'billing_address' => '630 East Oxford Drive',
            'billing_city' => 'Tempe',
            'billing_state' => 'AZ',
            'billing_zip' => '85283',
            'billing_country' => 'US',
        ...
        DB::table('locations')->insert([
            ...
            'user_id' => 3,
            'default' => 1,
            'address_line_1' => '630 east oxford drive',
            'city' => 'tempe',
            'state' => 'az',
            'zip' => '85283',
            'area' => 'Tempe',
