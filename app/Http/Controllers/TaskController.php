    ...
    private function getBidContractorJobTasks()
    {
        ...
        foreach ($bcjtasks as $bcjtask) {
            ...
            if (!\is_null($bcjtask->jobTask()->first())) {
                ...
                $bcjtask['job_task']['job']['sub_status'] = $bcjtask->jobTask()->get()->first()->subStatuses()->get()->where('user_id', '=', Auth::user()->getAuthIdentifier());
...
//        $jobTaskId = $request->jobTaskId;
//
//        $user_sub = User::getContractorByPhone($phone, $request->id);
//
//        $qb = new Quickbook();
