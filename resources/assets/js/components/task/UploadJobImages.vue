<template>
  ...
  <v-card>
    <v-card-text>
      ...
      <div v-if="showMoreImagesBtn(job)">
      ...
      >
        <v-card>
          <v-card-title>Image Help</v-card-title>
          <v-card-text>
            <images-job-help></images-job-help>
          </v-card-text>
        </v-card>
      </v-dialog>
...
<script>
import ImagesJobHelp from "../documentation/components/ImagesJobHelp";
