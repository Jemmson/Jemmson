    ...
    <div>
        <div class="container-fluid border-top" v-if="page !== '/' || user.usertype !== undefined">
            <div v-if="isLoggedIn" class="row mt-2 align-items-center justify-content-center">
                ...
                <div class="col d-flex align-items-center">
                    <figure @click.prevent="goTo('/invoices')" class="item mx-auto text-center"
                            :class="isCurrentPage('/invoices', '/invoices/')">
                        <i class="fas fa-file-alt sm-icon"></i>
                        <figcaption class="caption small-header" :class="isCurrentPage('/invoices', '/invoices/')">
                            Receipts
                        </figcaption>
                    </figure>
                </div>
            ...
            <div v-else class="row mt-2 align-items-center justify-content-center">
                ...
                <div class="col d-flex align-items-center">
                    <a href="/#/register" class="mx-auto">
                        <figure class="item mx-auto text-center"
                                :class="page === '/#/register' ? 'text-primary' : 'text-secondary'">
                            <i class="fas fa-user-plus text-secondary sm-icon"></i>
                            <figcaption class="caption small-header"
                                        :class="page === '/#/register' ? 'text-primary' : 'text-secondary'">Register
                            </figcaption>
                        </figure>
                    </a>
                </div>
