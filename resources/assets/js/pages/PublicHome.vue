...
<!--                    </v-btn>-->
            ...
            >
                ...
                <v-container class="text-center">
                    <h2 class="display-2 font-weight-bold mb-3">JEMMSON FEATURES</h2>
                                    ...
                                    <div>
                                        <v-avatar
                                                style="height: 6rem;
                                                    ...
                                                    padding-bottom: 1rem;"
                                        >
                                            <img :src="'/img/jobs.svg'" alt="" srcset="" class="mb-2"
                                            >
<!--                                            <v-icon-->
<!--                                                    large-->
<!--                                                    v-text="icon"-->
<!--                                            ></v-icon>-->
                            ...
                            >
                                    ...
                                    <div>
                                        <v-avatar
                                                style="height: 6rem;
                                                    ...
                                                    padding-bottom: 1rem;"
                                        >
                                            <img :src="'/img/tasks.svg'" alt="" srcset="" class="mb-2"
                                            >
                                            <!--                                            <v-icon-->
                                            <!--                                                    large-->
                                            <!--                                                    v-text="icon"-->
                                ...
                                <v-card-title
                                        class="justify-center font-weight-black text-uppercase"
                                >Sub It Out In A Snap</v-card-title>
                                    ...
                                    <div>
                                        <v-avatar
                                                style="height: 6rem;
                                                    ...
                                                    padding-bottom: 1rem;"
                                        >
                                            <img :src="'/img/invoices.svg'" alt="" srcset="" class="mb-2"
                                            >
                                            <!--                                            <v-icon-->
                                            <!--                                                    large-->
                                            <!--                                                    v-text="icon"-->
