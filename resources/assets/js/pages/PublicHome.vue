<template>
  <div class="home-page-wrapper">
    ...
    <!--<div class="row">-->
      ...
      <!--</div>-->
    <!--</div>-->
    <!--&lt;!&ndash; / end contractor features &ndash;&gt;-->
