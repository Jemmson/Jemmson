          ...
          <v-card-text>
            ...
            <div>
              ...
              <span class="help-block"
                    v-show="registerForm.errors.phoneNumber !== ''">{{ registerForm.errors.phoneNumber }}</span>
            ...
            <span class="help-block"
                  v-show="registerForm.errors.addressLine1 !== ''">{{ registerForm.errors.addressLine1 }}</span>
            ...
            <span class="help-block"
                  v-show="registerForm.errors.addressLine2 !== ''">{{ registerForm.errors.addressLine2 }}</span>
            ...
            <span class="help-block"
                  v-show="registerForm.errors.password !== ''">{{ registerForm.errors.password }}</span>
            ...
            <span class="help-block"
                  v-show="registerForm.errors.password_confirmation !== ''">{{
...
export default {
  ...
  computed: {
    ...
    checkZip() {
      if (this.getRegisterInfo) {
        return this.getRegisterInfo.zip
      }
    }
  },
  created() {
  ...
  methods: {
    ...
    saveRegisterInfo() {
      this.$store.commit('registerInfo', this.registerForm)
      localStorage.setItem('zip', this.registerForm.zip)
    },
    ...
    getZip() {
      if (this.getRegisterInfo.zip.length > 0) {
        this.registerForm.zip = this.getRegisterInfo.zip
      }
    },
        ...
        if (
          ...
          if (this.registerForm.usertype === 'contractor') {
            try {
              ...
              Bus.$emit('updateUser')
              this.$store.commit('registerInfo', null)
