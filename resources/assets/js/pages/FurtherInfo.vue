    ...
    <v-card v-if="infoNeedsUpdating">
      ...
      <v-card-text>
        ...
        <span class="help-block"
              v-show="form.errors.has('password_confirmation')">{{ form.errors.get('password_confirmation') }}</span>
