...
@section('content')
<div class="container">
    <h1 class="text-center">Exciting Contractor Features</h1>
    <div class="row">
        <div class="col-md-6">
                ...
                <div class="panel-body">
                    <div class="col-md-12 panelTop">
                        <div class="col-md-8">
                            ...
                            <p>As a contractor you will be able to easily track jobs
                                of each customer or subcontractor</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 panelTop">
                        <div class="col-md-8">
                            ...
                            <p>Credit Card security is paramount for our site. Your Credit Card is
                                protected by Stripe and the customer or subcontractor will never have access to your
                    ...
                    <div class="col-md-12 panelTop">
                        <div class="col-md-8">
                            ...
                            <p>Every Invoice that is generated between you and the
                                customer or contractor will be protected and archived whether you continue
            ...
            <div class="panel panel-default  panel--styled">
                <div class="panel-body">
                    <div class="col-md-12 panelTop">
                        <div class="col-md-8">
                            <h2>Communication</h2>
                            <p>You will be able to easily communicate with your customers and
                                subcontractors
